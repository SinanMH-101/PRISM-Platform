      ...
      <nav className="border-b border-brand-border bg-brand-surface/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/student/dashboard" className="focus-ring rounded-lg border border-brand-border px-3 py-2 text-sm font-semibold hover:bg-brand-background">Home</Link>
          </div>
        </div>
      </nav>
        ...
        <aside className="space-y-4">
          <div className="rounded-2xl border border-brand-border bg-brand-surface p-5 shadow-soft">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 text-sm">
              <Info label="TA" value={data.educatorName} /><Info label="Group" value={data.group.name} />
            </div>
          </div>
